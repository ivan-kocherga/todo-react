...
import { addTodoListItem, changeCompleteListItem, deleteCompleteTasks, deleteList } from '../redux/actions';
                            ...
                            return (
                                <div className='task' key={elem.id}>
                                    <input
                                        ...
                                        id={`task=${elem.id}`}
                                    />
                                    <label htmlFor={`task=${elem.id}`} onClick={() => changeComplete(elem.id)}>
                    ...
                    <div className='new-task-creator'>
                        <div className='form tasks'>
                            <input
                                ...
                                value={input}
                            />
                            <button onClick={createTodoListItem} className='btn create' aria-label='create new task'>+</button>
                        </div>
                    </div>
                </div>

                <div className="delete-stuff">
                    <button className="btn delete" onClick={clearDoneTasks}>Clear completed tasks</button>
                    <button className="btn delete" onClick={deleteListHandler}>Delete list</button>
                </div>
